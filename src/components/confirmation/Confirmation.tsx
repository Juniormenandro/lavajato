...
const Confirmation = () => {
  ...
  console.log(id, formattedDate, selectedTime, 'booking details');
      ...
      <div className="max-w-xl mx-auto px-4 py-8">
        ...
        <main className="bg-white shadow overflow-hidden rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-5">
              <p>For any questions or changes, please contact us at junior@donejobs.com or call (087) 476-2708.</p>
            </div>
          </div>
